...
Nucleeo board for IoT node with STM32WBA series
https://www.st.com/en/microcontrollers-microprocessors/stm32wba65ri.html
...
.. code-block:: bash
    ...
    cmake -S /../tf-m-tests/tests_reg/spe -B . -GNinja -DTFM_PLATFORM=stm/nucleo_wba65ri
...
.. code-block:: bash
    ...
    cmake -S /../tf-m-tests/tests_psa_arch/spe -B . -GNinja -DTFM_PLATFORM=stm/nucleo_wba65ri
         -DTFM_TOOLCHAIN_FILE= /../toolchain_ARMCLANG.cmake
         -DCONFIG_TFM_SOURCE_PATH= /../trusted-firmware-m
         -DTFM_PSA_API=ON -DTFM_ISOLATION_LEVEL=1
...
TODO: TFM BL2 from MCUBOOT not supported: need OEMiROT
